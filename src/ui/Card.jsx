...
const Card = (
  ...
  return (
    <div className='w-full p-2 shadow-xs rounded-lg flex flex-col relative bg-white h-[280px]'>
        <div className="flex justify-start mb-2">{title}</div>
        <div className='flex item-start justify-center flex-col w-full hover:overflow-y-scroll overflow-hidden'>
